...
static union {
    struct {
        ...
        uint8_t CH9_flag            : 2; // 25,26   // ch9 aux switch : 0 is low or false, 1 is center or true, 2 is high
        uint8_t CH10_flag           : 2; // 27,28   // ch10 aux switch : 0 is low or false, 1 is center or true, 2 is high
        uint8_t CH11_flag           : 2; // 29,30   // ch11 aux switch : 0 is low or false, 1 is center or true, 2 is high
        // after bit 31, bits are not logged
        uint8_t CH12_flag           : 2; // 31,32   // ch12 aux switch : 0 is low or false, 1 is center or true, 2 is high
    };
    uint32_t value;
} ap;
