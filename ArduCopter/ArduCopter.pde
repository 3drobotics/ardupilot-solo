...
static union {
    struct {
        uint8_t test_landed         : 1; // 0       // This is true when the upper pwm value being reduced to test if the vehicle is landed
...
static bool gps_glitch_switch_mode_on_resolve = false;
