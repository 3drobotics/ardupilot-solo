						       ...
						       uint64_t time_usec, int16_t xacc, int16_t yacc, int16_t zacc, int16_t xgyro, int16_t ygyro, int16_t zgyro, int16_t xmag, int16_t ymag, int16_t zmag)
{
	...
	_mav_put_int16_t(buf, 24, zmag);
		...
		mav_put_int16_t_c2000(&(msg->payload64[0]), 8, xacc);
		mav_put_int16_t_c2000(&(msg->payload64[0]), 10, yacc);
		mav_put_int16_t_c2000(&(msg->payload64[0]), 12, zacc);
		mav_put_int16_t_c2000(&(msg->payload64[0]), 14, xgyro);
		mav_put_int16_t_c2000(&(msg->payload64[0]), 16, ygyro);
		mav_put_int16_t_c2000(&(msg->payload64[0]), 18, zgyro);
		mav_put_int16_t_c2000(&(msg->payload64[0]), 20, xmag);
		mav_put_int16_t_c2000(&(msg->payload64[0]), 22, ymag);
		mav_put_int16_t_c2000(&(msg->payload64[0]), 24, zmag);
