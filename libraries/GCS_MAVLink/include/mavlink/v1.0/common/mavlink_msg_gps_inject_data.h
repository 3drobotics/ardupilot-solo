						       ...
						       uint8_t target_system, uint8_t target_component, uint8_t len, const uint8_t *data)
{
	...
	_mav_put_uint8_t_array(buf, 3, data, 110);
		...
		mav_put_uint8_t_c2000(&(msg->payload64[0]), 2, len);
	
		mav_put_uint8_t_array_c2000(&(msg->payload64[0]), data, 3, 110);
...
#else
	return mav_get_uint8_t_array_c2000(&(msg->payload64[0]), data, 110,  3);
#endif
}
