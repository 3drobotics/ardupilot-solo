						       ...
						       uint32_t time_boot_ms, float q1, float q2, float q3, float q4, float rollspeed, float pitchspeed, float yawspeed)
{
	...
	_mav_put_float(buf, 28, yawspeed);
		...
		mav_put_float_c2000(&(msg->payload64[0]), 4, q1);
		mav_put_float_c2000(&(msg->payload64[0]), 8, q2);
		mav_put_float_c2000(&(msg->payload64[0]), 12, q3);
		mav_put_float_c2000(&(msg->payload64[0]), 16, q4);
