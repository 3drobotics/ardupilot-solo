						       ...
						       int32_t lat, int32_t lon, uint16_t grid_spacing, uint8_t gridbit, const int16_t *data)
{
	...
	_mav_put_int16_t_array(buf, 10, data, 16);
		...
		mav_put_uint16_t_c2000(&(msg->payload64[0]), 8, grid_spacing);
		mav_put_uint8_t_c2000(&(msg->payload64[0]), 42, gridbit);
	
		mav_put_int16_t_array_c2000(&(msg->payload64[0]), data, 10, 16);
...
#else
	return mav_get_int16_t_array_c2000(&(msg->payload64[0]), data, 16,  10);
#endif
}
