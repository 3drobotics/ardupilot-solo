...
{
	MAV_MODE_GIMBAL_UNINITIALIZED=0, /* Gimbal is powered on but has not received an initialize command from the host vehicle | */
	MAV_MODE_GIMBAL_HOMING=1, /* Gimbal is currently executing its homing routine | */
	MAV_MODE_GIMBAL_STABILIZED_RATE=2, /* Gimbal is actively stabilizing, taking rate commands | */
	MAV_MODE_GIMBAL_STABILIZED_ANGLE=3, /* Gimbal is actively stabilizing, taking angle target commands | */
	MAV_MODE_GIMBAL_FAULT=4, /* Gimbal has experienced a fault, and is currently in limp mode | */
	MAV_MODE_GIMBAL_ENUM_END=5, /*  | */
} MAV_MODE_GIMBAL;
#endif
...
typedef enum MAG_CAL_STATUS
{
	...
	MAG_CAL_SAMPLING_STEP_ONE=2, /*  | */
	MAG_CAL_SAMPLING_STEP_TWO=3, /*  | */
	MAG_CAL_SUCCESS=4, /*  | */
	MAG_CAL_FAILED=5, /*  | */
