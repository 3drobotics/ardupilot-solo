...
#define MAVLINK_MSG_ID_GPS_ACCURACY 195
...
#define MAVLINK_MSG_ID_GPS_ACCURACY_LEN 21
#define MAVLINK_MSG_ID_195_LEN 21

#define MAVLINK_MSG_ID_GPS_ACCURACY_CRC 93
#define MAVLINK_MSG_ID_195_CRC 93
...
static inline uint16_t mavlink_msg_gps_accuracy_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
						       uint8_t instance, float h_acc, float s_acc, float h_vel_filt, float v_vel_filt, float p_drift)
{
...
{
	return mavlink_msg_gps_accuracy_pack(system_id, component_id, msg, gps_accuracy->instance, gps_accuracy->h_acc, gps_accuracy->s_acc, gps_accuracy->h_vel_filt, gps_accuracy->v_vel_filt, gps_accuracy->p_drift);
}
...
{
	return mavlink_msg_gps_accuracy_pack_chan(system_id, component_id, chan, msg, gps_accuracy->instance, gps_accuracy->h_acc, gps_accuracy->s_acc, gps_accuracy->h_vel_filt, gps_accuracy->v_vel_filt, gps_accuracy->p_drift);
}
...
static inline void mavlink_msg_gps_accuracy_send(mavlink_channel_t chan, uint8_t instance, float h_acc, float s_acc, float h_vel_filt, float v_vel_filt, float p_drift)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[MAVLINK_MSG_ID_GPS_ACCURACY_LEN];
	_mav_put_float(buf, 0, h_acc);
 ...
 */
static inline void mavlink_msg_gps_accuracy_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t instance, float h_acc, float s_acc, float h_vel_filt, float v_vel_filt, float p_drift)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
